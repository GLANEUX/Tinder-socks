    ...
    <div class="form-container">
      <div class="form-content">
        ...
        <section id="container--match">
          ...
          <?php
          $data = $conn->prepare("SELECT * FROM users WHERE username=:y");
          $data->execute([":y" => "$username"]);
          ...
          <form action="controller/account_modified_controller.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="main-informations">
              ...
              <div style=" display: flex; column-gap: 20px;  width: 80%; margin-left: 10%; align-items: center;">
                <figure>
                  <img style="border-radius: 20px; max-width: 100px; " src=<?= $users['image'] ?> alt="#">
                </figure>
