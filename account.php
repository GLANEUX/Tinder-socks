    ...
    <div class="form-container">
      <div class="form-content">
        ...
        <section id="container--match">
          ...
          <?php } ?>
          <form action="controller/account_modified_controller.php" method="POST" enctype="multipart/form-data">
            <h3>Modifier vos informations personnel</h3>
            <div class="main-informations">
              <label for="name">
                <input type="text" id="name" placeholder="Pseudo" value="<?= $users['username'] ?>" name="name"
                  required />
              </label>
              <label for="email">
                <input type="email" id="email" placeholder="Mail" value="<?= $users['email'] ?>" name="email"
                  required />
              </label>
              <label for="password">
              ...
              <label for="description">
                <input type="text" id="description" value="<?= $users['description'] ?>" placeholder="Description"
              ...
              foreach ($couleurs as $couleur):
                ...
                <div>
                  <label for="<?= $couleur['couleur']; ?>">
                    <input id="<?= $couleur['couleur']; ?>" type="radio" name="couleur" <?php if ($couleur['couleur'] == $users['couleur']) { ?> checked <?php }
                      ; ?>
                      value="<?= $couleur['couleur']; ?>" required />
                    <span>
                      <?= $couleur['couleur']; ?>
                    </span>
                  </label>
              ...
              foreach ($marques as $marque):
                ...
                <div>
                  <label for="<?= $marque['marque']; ?>">
                    <input id="<?= $marque['marque']; ?>" <?php if ($marque['marque'] == $users['marque']) { ?> checked <?php }
                      ; ?> type="radio" name="marque" value="<?= $marque['marque']; ?>" required />
                    <span>
                      <?= $marque['marque']; ?>
                    </span>
                  </label>
              ...
              foreach ($tailles as $taille):
                ...
                <div>
                  <label for="<?= $taille['taille']; ?>">
                    <input id="<?= $taille['taille']; ?>" <?php if ($taille['taille'] == $users['taille']) { ?> checked <?php }
                      ; ?> type="radio" name="taille" value="<?= $taille['taille']; ?>" required />
                    <span>
                      <?= $taille['taille']; ?>
                    </span>
                  </label>
