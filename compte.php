...
" src=<?= $users['image'] ?> alt="#" >
            ...
            <input  style="    height: 10%;" type="file" class="form-control" id="visuel" name="visuel"  /></div>
          </div>
            ...
            foreach ($couleurs as $couleur):
              ...
              <div>
                <label for="<?= $couleur['couleur']; ?>">
                  <input id="<?= $couleur['couleur']; ?>" type="radio" name="couleur" <?php if($couleur['couleur'] == $users['couleur']){ ?> checked <?php }; ?> value="<?= $couleur['couleur']; ?>"
                    required />
                  <span>
                    <?= $couleur['couleur']; ?>
                  </span>
            ...
            foreach ($marques as $marque):
              ...
              <div>
                <label for="<?= $marque['marque']; ?>">
                  <input id="<?= $marque['marque']; ?>" <?php if($marque['marque'] == $users['marque']){ ?> checked <?php }; ?> type="radio" name="marque" value="<?= $marque['marque']; ?>"
                    required />
                  <span>
                    <?= $marque['marque']; ?>
                  </span>
            ...
            foreach ($tailles as $taille):
              ...
              <div>
                <label for="<?= $taille['taille']; ?>">
                  <input id="<?= $taille['taille']; ?>" <?php if($taille['taille'] == $users['taille']){ ?> checked <?php }; ?> type="radio" name="taille" value="<?= $taille['taille']; ?>"
                    required />
                  <span>
                    <?= $taille['taille']; ?>
                  </span>
